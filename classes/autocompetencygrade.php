...
class autocompetencygrade {
	public static $avaliacoes_3T = array(
		34281,34343,35823,35893,42273,36267,33096,33054,30207,35194,35147,35094,33288,33246,37058,37100,33372,33414,30011,34992,32928,32970,30072,33012,31620,31681,32758,32800,32844,29991,32886,32705,33936,32643,32078,32009,29424,33119,32351,30857,30925,34000,34474,34034,37279,37328,34546,34551,34541,33330,34519,34562,34567,34556,35246,35487,35060,38755,38764,38760,38768,35016,34668,27356,35026,35021,30433,38655,34143
	);
	...
	public static function gradeassigncompetencies_printableresult($assign_moduleid, $student_userid, $courseid = null) {
		...
		$result_content = \html_writer::tag('p', get_string($result['msg'], 'local_autocompetencygrade'));
		...
		$result_content .= \html_writer::link(
			...
			get_string($link_string, 'local_autocompetencygrade'),
			array(
				'target' => '_blank'
			)
		);
