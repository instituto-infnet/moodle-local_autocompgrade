...
$string['consistencycheck_studentswithoutplan'] = 'Estudantes com planos faltando';
$string['consistencycheck_submit'] = 'Aplicar filtro';
...
$string['gradeassigncompetencies_linkgrader'] = 'Clique aqui para ver a tela da correção.';
$string['gradeassigncompetencies_linkquizattempts'] = 'Clique aqui para ver as tentativas realizadas no questionário.';
$string['gradeassigncompetencies_notupdatedgrades'] = 'Disciplinas e estudantes com competências desatualizadas';
$string['gradeassigncompetencies_selectcoursestudent'] = 'Disciplina e estudante';
$string['gradeassigncompetencies_student'] = 'Estudante';
...
$string['gradeassigncompetencies_updatedgrades'] = 'Disciplinas e estudantes com competências atualizadas';
$string['gradeassigncompetencies_updatedgradesheader'] = 'Competências atualizadas';
